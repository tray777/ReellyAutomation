...
class Page:
    ...
    def switch_to_new_window(self):
        self.wait.until(EC.new_window_is_opened) #if this stops working, use EC.number_of_windows_to_be()
        all_windows = self.driver.window_handles #[wind1, window2]
        self.driver.switch_to.window(all_windows[1])

    def switch_to_window_by_id(self, window_id): #this will take you back to original window
